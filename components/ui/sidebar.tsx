...
const SidebarContextUI = React.createContext<SidebarContext | null>(null)

function useSidebar() {
  const context = React.use(SidebarContextUI)
  if (!context) {
...
const SidebarProvider = ({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: this is only for client side
  ...
  return (
    <SidebarContextUI value={contextValue}>
